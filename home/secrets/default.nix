{ inputs, pkgs, ... }: {
  ...
  age = {
    ...
    rekey = {
      hostPubkey =
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIL8sBfh3Y90/+Za1gdqVIMyhT3+QwkCOugIVRBkmoWiJ me@toino.pt";
    ...
    secrets = {
      ...
      vdirsyncer-google-client-secret.rekeyFile =
        ./vdirsyncer_google_client_secret.age;
    };
  };
}
