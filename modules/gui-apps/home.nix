{ pkgs, ... }:
{
  ...
  xdg.mimeApps = {
    ...
    defaultApplications =
      ...
      in
      (makeDefaultForAll "firefox.desktop" [
      ...
      // (makeDefaultForAll "org.pwmt.zathura-djvu.desktop" [
        "image/vnd.djvu"
        "image/vnd.djvu+multipage"
      ])
      // (makeDefaultForAll "org.pwmt.zathura-pdf-mupdf.desktop" [
        "application/pdf"
        "application/oxps"
        "application/epub+zip"
        "application/x-fictionbook"
      ])
      // (makeDefaultForAll "org.pwmt.zathura-ps.desktop" [
